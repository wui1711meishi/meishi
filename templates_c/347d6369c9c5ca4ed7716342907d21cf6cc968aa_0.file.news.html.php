<?php
/* Smarty version 3.1.30, created on 2018-04-19 05:16:53
  from "D:\wamp\www\meishi\templates\index\news.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ad80a256cde39_64796497',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '347d6369c9c5ca4ed7716342907d21cf6cc968aa' => 
    array (
...
function content_5ad80a256cde39_64796497 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
logo.png" alt="">
    ...
    <div class="tw_content">
        ...
        <div class="znew">
            <div class="guide">
                <p class="thenew">THE NEW</p>
                <ul class="csd">
                    <li></li>
                    <li></li>
                    <li></li>
                </ul>
                <p class="enew"><b>DESIGNER</b> DESIGN</p>
                <div class="chinnew">
                    <p>最新新闻</p>
                    <div class="xiaok"></div>
                </div>
...
wqsss_03.png" alt="">
            ...
            <div class="newtit">
                <div class="newtit_k">
                    <h3>面包也需要创意</h3>
                    <p>没有什么是设计解决不了的／设计大赛获奖感言</p>
                </div>
                <p class="new_wenzi">设计是把一种计划、规划、设想通过某种形式传达出来的活动过程。人类通过劳动改造世界，创造文明，创造物质财富和精神财富，而最基础、最主要的创造活动是造物。设计便是造物活动进行预先的计划……</p>
                <div class="new_time">
                    <i>&#xe619;</i><em>2018 01.15</em>
                </div>
            </div>
        </div>
        <!--新闻列表-->
